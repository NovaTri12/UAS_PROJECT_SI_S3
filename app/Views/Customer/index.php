<?= $this->extend('templates/customer_layout'); ?>
<?= $this->section('customerContent'); ?>
                            ...
                            <div class="card info-card membership-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ps-3">
                                            <h6>Active</h6>
                                            <span class="text-success small pt-1 fw-bold">Until</span> <span class="text-muted small pt-2 ps-1">27 January 2022</span>
